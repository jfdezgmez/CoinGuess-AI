...
/**
		 * Random Agent - Random bet
		 * @author Jose Fernandez 
		 * @version 17/01/2018
		 * https://github.com/jfdezgmez
		 */

public class psi3_Random extends Agent {
	private int id;
	private static int max = 0;

	protected void takeDown() {

		System.out.println("El randomAgent ha terminado");

	}

	protected void setup() {
		System.out.println("Hola, soy el randomAgent");
